...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymilvus-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12603&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymilvus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymilvus` can be installed with:

```
conda install pymilvus
```

It is possible to list all of the versions of `pymilvus` available on your platform with:
